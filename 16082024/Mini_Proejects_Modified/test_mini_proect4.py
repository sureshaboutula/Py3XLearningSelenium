...
def test_mini_project_4():
    ...
    WebDriverWait(driver=driver, timeout=5).until(
        EC.presence_of_element_located((By.XPATH,
                                        "//button[contains(@class, 'id-info-btn-frm')]"))
    )
    ...
    email_web_element = driver.find_element(By.XPATH, "//input[@id='username']")
    ...
    email_web_element = driver.find_element(By.XPATH, "//input[contains(@class, 'ng-valid')][@id='password']")
    ...
    WebDriverWait(driver=driver, timeout=5).until(
        EC.presence_of_element_located((By.XPATH,
                                        "//span[contains(normalize-space(), 'Your free trial has expired')]"))
    )
    allure.attach(driver.get_screenshot_as_png(), name="Expired-message-screenshot")
